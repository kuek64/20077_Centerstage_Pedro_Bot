...
public class FollowerConstants {
    ...
    private static double xMovement = 65.63489445287716;
    private static double yMovement = 53.33277636580694;
    ...
    public static double forwardZeroPowerAcceleration = -31.31412821838307;
